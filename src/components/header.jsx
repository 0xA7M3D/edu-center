...
function Header(){
    return(
        <div className="header border-b border-gray-800 w-full p-4 flex justify-between gap-2 items-center">
            <div className="inp flex items-center gap-2 border border-gray-700/70 bg-gray-600/10 rounded-lg pr-3">
                <i className="far fa-search text-lg pl-4 text-gray-600"></i>
                <input className="p-3 text-sm outline-none w-80" type="text" placeholder="Search students,numbers" />
