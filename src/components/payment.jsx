...
<<<<<<< HEAD
    ...
    function submit() {
        ...
        fetch(`http://localhost:3000/payment/${userId}`,{
            method:"get",
        })
        .then(res => res.json())
        .then(da => {
...
<<<<<<< HEAD
                        <input onChange={(e)=>{setUserId(e.target.value)}} value={userId} className="border border-gray-800/70 rounded-lg text-xl p-1 px-3 text-center" type="number" />
=======
...
<<<<<<< HEAD
                    <h1 className={`no-found text-2xl ${!done ? "active":""} text-gray-700 text-center max-w-100`}>Scan First For payment and show info student</h1>
=======
